...
public class SpacesDigitalOceanService : ISpacesDigitalOceanService
{
        ...
        public SpacesDigitalOceanService(ILogger<SpacesDigitalOceanService> logger,
                                         IApplicationConfiguration applicationConfiguration)
        {
           
            _applicationConfiguration = applicationConfiguration;
            _bucketName = _applicationConfiguration.BucketName;
            _S3Config = new AmazonS3Config()
            {
                ServiceURL = _applicationConfiguration.ServiceURL,
                SignatureVersion = _applicationConfiguration.SignatureVersion
            };
            _S3Client = new AmazonS3Client(_applicationConfiguration.AccessKey,
                                           _applicationConfiguration.SecretAccessKey,
                                           _S3Config);
            _logger = logger;
        }
